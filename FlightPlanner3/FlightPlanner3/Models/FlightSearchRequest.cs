...
namespace FlightPlanner3.Models
{
    ...
    {
        public FlightSearchRequest(IFlightService flightService, IMapper mapper) 
        ...
        public static bool IsRequestedFlightPresentInStorage(IEnumerable<Flight> flights, 
            FlightSearchRequest fReq)
        {
        ...
        public static List<Flight> GetFlightMatchingRequest(IEnumerable<Flight> flights, 
            FlightSearchRequest fReq)
        {
        ...
        public static PageResult<Flight> ReturnPageResults(IEnumerable<Flight> flights, FlightSearchRequest fReq)
        {
            ...
            var resultMatched = GetFlightMatchingRequest(flights, fReq)
                .DistinctBy(d => d.DepartureTime)
                .ToList();
